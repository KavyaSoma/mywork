...
<div class="col-xs-12 col-sm-12">
   <div class="panel panel-default magic-element isotope-item">
             <div class="panel-body-heading edituser_panel">
                 <h4 class="pb-title" style="padding:5px;">Groups [{{count($groups)}}]</h4>
<!-- Modal -->
...
<div class="col-sm-1">
<a href="#"><img src="{{url('public/images/group.jpg')}}" height="60px" width="60px" id="group_img" data-toggle="modal" data-target="#myModal4" onclick="members('{{$group->GroupName}}','{{$group->GroupId}}')" /></a>
</div>
@endforeach

@endif
<center><button class="btn btn-warning" data-toggle="modal" data-target="#myModal2">Create New Group</button>&nbsp;&nbsp;&nbsp;
   <a href="{{url('group/')}}" class="btn btn-primary">View All Groups</a></center>
</div>
</div>
 </div>
