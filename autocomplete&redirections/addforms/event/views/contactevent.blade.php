                  ...
                  <div class="row">
                    <div class="form-group">
                      ...
                      <div class="col-xs-7 col-sm-6">
                        <input type="text" class="form-control" id="txt" name="club_name" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-xs-4 col-sm-4" for="txt">Mobile:</label>
                      <div class="col-xs-7 col-sm-6">
                        <input type="text" class="form-control" id="txt" name="club_mobile" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-xs-4 col-sm-4" for="email">Email:</label>
                      <div class="col-xs-7 col-sm-6">
                        <input type="email" class="form-control" id="email" name="club_email" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-xs-4 col-sm-4" for="txt">Website:</label>
                      <div class="col-xs-7 col-sm-6">
                        <input type="text" class="form-control" id="txt" name="club_website" required>
                      </div>
                    </div>
                    <center>
                        ...
                        {{ csrf_field() }}
                              <div class="row">
                                <div class="form-group">
                                  ...
                                  <div class="col-xs-7 col-sm-6">
                                    <input type="text" class="form-control" id="txt" name="event_contact" required>
                                  </div>
                                </div>
                                <div class="form-group">
                                  <label class="control-label col-xs-4 col-sm-4" for="txt">Mobile:</label>
                                  <div class="col-xs-7 col-sm-6">
                                    <input type="text" class="form-control" id="txt" name="event_mobile" required>
                                  </div>
                                </div>
                                <div class="form-group">
                                  <label class="control-label col-xs-4 col-sm-4" for="email">Email:</label>
