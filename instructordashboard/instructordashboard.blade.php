                  ...
                  <tr>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="{{url('participant/'.$instructor->ParticipantId.'/'.$instructor->VenueId)}}"><span class="glyphicon glyphicon-ok" style="color: green"></span></a>/ <a href="{{url('deleteparticipant/'.$instructor->ParticipantId.'/'.$instructor->VenueId)}}"><span class="glyphicon glyphicon-remove" style="color: red"></span></a></td>
                      </tr>
                      @endforeach
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{$accepted->VenueName}}</td>
                         <td><a href="{{url('participant/'.$accepted->ParticipantId.'/'.$accepted->VenueId)}}"><span class="glyphicon glyphicon-ok" style="color: green"></span></a>/ <a href="{{url('deleteparticipant/'.$accepted->ParticipantId.'/'.$accepted->VenueId)}}"><span class="glyphicon glyphicon-remove" style="color: red"></span></a></td>
                      </tr>
                      @endforeach
